...
def otp_publish_colab_cli_article(request):
    if request.GET.get("key") != "colab-cli-2026-5c9a8e1b2d3f":
        raise Http404()
    ...
    path = Path(__file__).resolve().parent.parent / "drafts" / "google-colab-cli-remote-gpu-ai-agent-workflows-2026.json"
