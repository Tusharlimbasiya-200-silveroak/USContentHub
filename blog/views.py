...
def otp_add_quality_sources(request):
    source_sections = {
        "auto-cars": """
<h2>Sources &amp; Accuracy Note</h2>
<p>This article is for general informational purposes. Vehicle prices, features, safety ratings, incentives, and availability can change by market and trim, so verify current details with official sources before making a purchase decision.</p>
<ul>
<li><a href="https://www.nhtsa.gov/ratings" target="_blank" rel="noopener noreferrer">NHTSA vehicle safety ratings</a></li>
<li><a href="https://www.fueleconomy.gov/" target="_blank" rel="noopener noreferrer">U.S. Department of Energy and EPA FuelEconomy.gov</a></li>
<li><a href="https://www.tatamotors.com/press-releases/" target="_blank" rel="noopener noreferrer">Tata Motors official press releases</a></li>
</ul>
""",
        "health-wellness-daily": """
<h2>Sources &amp; Medical Accuracy Note</h2>
<p>This article is educational and is not a substitute for professional medical advice. Health recommendations can vary by age, medical history, pregnancy status, medications, and individual risk factors. Consult a licensed clinician before changing treatment, diet, exercise, supplement, or sleep routines.</p>
<ul>
<li><a href="https://www.cdc.gov/physical-activity-basics/guidelines/index.html" target="_blank" rel="noopener noreferrer">CDC physical activity guidelines</a></li>
<li><a href="https://medlineplus.gov/" target="_blank" rel="noopener noreferrer">NIH MedlinePlus health information</a></li>
<li><a href="https://www.nhlbi.nih.gov/health/sleep" target="_blank" rel="noopener noreferrer">NIH/NHLBI sleep health resources</a></li>
<li><a href="https://www.nutrition.gov/" target="_blank" rel="noopener noreferrer">Nutrition.gov evidence-based nutrition resources</a></li>
</ul>
""",
        "recipe-kitchen-usa": """
<h2>Sources &amp; Food Safety Note</h2>
<p>Cooking times, ingredient brands, appliance power, and food sizes vary. Use a food thermometer for safety-critical recipes and follow official food safety guidance for storage, reheating, and minimum internal temperatures.</p>
<ul>
<li><a href="https://www.foodsafety.gov/food-safety-charts/safe-minimum-internal-temperatures" target="_blank" rel="noopener noreferrer">FoodSafety.gov safe minimum internal temperatures</a></li>
<li><a href="https://www.fsis.usda.gov/food-safety" target="_blank" rel="noopener noreferrer">USDA FSIS food safety guidance</a></li>
<li><a href="https://www.myplate.gov/" target="_blank" rel="noopener noreferrer">USDA MyPlate nutrition guidance</a></li>
</ul>
""",
        "smart-money-guide": """
<h2>Sources &amp; Financial Accuracy Note</h2>
<p>This article is educational and does not provide personalized financial, tax, legal, or investment advice. Rates, limits, eligibility rules, tax treatment, and consumer protections change over time. Confirm current details with official sources or a qualified professional.</p>
<ul>
<li><a href="https://www.investor.gov/" target="_blank" rel="noopener noreferrer">SEC Investor.gov</a></li>
...
<li><a href="https://www.fdic.gov/resources/deposit-insurance/" target="_blank" rel="noopener noreferrer">FDIC deposit insurance resources</a></li>
</ul>
""",
        "tech-gadget-hub": """
<h2>Sources &amp; Accuracy Note</h2>
<p>Technology specs, prices, warranties, software support windows, AI capabilities, and cybersecurity recommendations change frequently. Verify current product details with the manufacturer and use official security guidance when acting on technical recommendations.</p>
<ul>
<li><a href="https://www.cisa.gov/secure-our-world" target="_blank" rel="noopener noreferrer">CISA Secure Our World cybersecurity guidance</a></li>
<li><a href="https://www.nist.gov/cybersecurity" target="_blank" rel="noopener noreferrer">NIST cybersecurity resources</a></li>
<li><a href="https://www.ftc.gov/business-guidance/privacy-security" target="_blank" rel="noopener noreferrer">FTC privacy and security guidance</a></li>
</ul>
""",
        "tech-pulse": """
<h2>Sources &amp; Accuracy Note</h2>
<p>Developer tooling, AI models, framework releases, benchmarks, and security advisories move quickly. Verify version numbers, release notes, and migration steps against the original project or vendor documentation before making production decisions.</p>
<ul>
<li><a href="https://www.cisa.gov/news-events/cybersecurity-advisories" target="_blank" rel="noopener noreferrer">CISA cybersecurity advisories</a></li>
<li><a href="https://nvd.nist.gov/" target="_blank" rel="noopener noreferrer">NIST National Vulnerability Database</a></li>
<li><a href="https://github.blog/changelog/" target="_blank" rel="noopener noreferrer">GitHub Changelog</a></li>
</ul>
""",
        "the-trading-blueprint": """
<h2>Sources &amp; Trading Risk Note</h2>
<p>This article is for educational purposes only and is not financial advice. Trading involves risk, leveraged products can amplify losses, and market rules or evaluation terms can change. Verify current contract specs, exchange rules, and firm-specific terms before trading.</p>
<ul>
<li><a href="https://www.investor.gov/" target="_blank" rel="noopener noreferrer">SEC Investor.gov investor education</a></li>
<li><a href="https://www.cftc.gov/LearnAndProtect/index.htm" target="_blank" rel="noopener noreferrer">CFTC Learn &amp; Protect resources</a></li>
<li><a href="https://www.finra.org/investors" target="_blank" rel="noopener noreferrer">FINRA investor education</a></li>
<li><a href="https://www.cmegroup.com/education.html" target="_blank" rel="noopener noreferrer">CME Group education and contract resources</a></li>
</ul>
""",
        "usa-news-digest": """
<h2>Sources &amp; Accuracy Note</h2>
<p>News and public-policy information can change quickly as agencies update releases, courts issue decisions, or new data becomes available. Verify time-sensitive claims against primary sources and official datasets.</p>
<ul>
<li><a href="https://www.usa.gov/" target="_blank" rel="noopener noreferrer">USA.gov official government information</a></li>
<li><a href="https://www.bls.gov/" target="_blank" rel="noopener noreferrer">U.S. Bureau of Labor Statistics</a></li>
<li><a href="https://www.census.gov/" target="_blank" rel="noopener noreferrer">U.S. Census Bureau</a></li>
<li><a href="https://www.federalreserve.gov/" target="_blank" rel="noopener noreferrer">Federal Reserve official releases</a></li>
</ul>
""",
        "usa-travel-explorer": """
<h2>Sources &amp; Travel Accuracy Note</h2>
<p>Travel rules, park access, fees, weather, road conditions, and safety advisories can change without notice. Confirm current details with official sources before booking or traveling.</p>
<ul>
<li><a href="https://www.tsa.gov/travel" target="_blank" rel="noopener noreferrer">TSA travel guidance</a></li>
<li><a href="https://www.nps.gov/index.htm" target="_blank" rel="noopener noreferrer">National Park Service</a></li>
<li><a href="https://travel.state.gov/" target="_blank" rel="noopener noreferrer">U.S. Department of State travel resources</a></li>
<li><a href="https://www.weather.gov/" target="_blank" rel="noopener noreferrer">National Weather Service</a></li>
</ul>
""",
    }
    ...
    updated = 0
    skipped = 0
    for article in Article.objects.select_related("publication").filter(status="published"):
        pub_slug = article.publication.slug if article.publication else ""
        section = source_sections.get(pub_slug)
        if not section:
            skipped += 1
            continue
        content = article.content or ""
        if re.search(r"<h2>\s*(sources|references|further reading)", content, re.I):
            skipped += 1
            continue
        article.content = content.rstrip() + section
        article.save(update_fields=["content", "updated_at"])
        updated += 1

    return HttpResponse(f"Quality source sections added: {updated}; skipped: {skipped}")
